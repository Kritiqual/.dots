# Generated by Powerlevel10k configuration wizard on 2026-03-07 at 02:15 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # rbenv                   # ruby version from rbenv (https://github.com/rbenv/rbenv)a
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNTRACKED  )) && res+=" ${conflicted}${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}"
